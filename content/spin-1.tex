...
\begin{e}
  M = -\frac{e^2}{m}\frac{1 + \sin\theta}{1 + \sin\theta - 2\delta}.
\end{e}
\jtd{There's a problem with the sign of $(p-q')^2$ and I think $M$ should decrease with rising $\delta$, not increase.}
